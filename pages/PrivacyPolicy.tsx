  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto py-16 px-8 bg-black text-white"> {/* Adjusted max-width, padding */}
        <div className="bg-neutral-800 p-12 rounded-4xl shadow-xl"> {/* Content wrapper for privacy policy */}
          <SectionHeader headline="Our Commitment to Your Privacy" align="left" className="mb-16" /> {/* Adjusted margin-bottom */}
          ...
          <div className="prose prose-xl prose-invert max-w-none text-white space-y-8"> {/* Adjusted prose size, space-y */}
            ...
            <h2 className="text-gold-accent mt-10">Information We Collect</h2> {/* Adjusted margin-top */}
            ...
            <h2 className="text-gold-accent mt-10">How We Use Your Information</h2> {/* Adjusted margin-top */}
            ...
            <h2 className="text-gold-accent mt-10">Disclosure of Your Information</h2> {/* Adjusted margin-top */}
            ...
            <h2 className="text-gold-accent mt-10">Security of Your Data</h2> {/* Adjusted margin-top */}
            ...
            <h2 className="text-gold-accent mt-10">Changes to This Privacy Policy</h2> {/* Adjusted margin-top */}
